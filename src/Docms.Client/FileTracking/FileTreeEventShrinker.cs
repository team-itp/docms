...
{
    public class FileTrackingEventShrinker
    {
        private List<FileTrackingEvent> _events = new List<FileTrackingEvent>();

        public IEnumerable<FileTrackingEvent> Events => _events;

        public void Apply(FileTrackingEvent ev)
        {
