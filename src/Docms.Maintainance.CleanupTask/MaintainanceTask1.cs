...
namespace Docms.Maintainance.CleanupTask
{
    class MaintainanceTask1
    {
        ...
        public MaintainanceTask1(ServiceProvider services, IConfiguration configuration, IDataStore dataStore, Func<IConfiguration, DocmsContext> contextFuctory)
        {
