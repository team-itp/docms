...
namespace Docms.Web.Application.Commands
{
    public class AddNewDeviceCommandHandler : IRequestHandler<AddNewDeviceCommand, bool>
    {
        ...
        public async Task<bool> Handle(AddNewDeviceCommand request, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            device = new Device(request.DeviceId);
